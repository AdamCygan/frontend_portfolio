...
export const ListContainer = ({ data, boardId }: ListContainerProps) => {
  ...
  const onDragEnd = (result: any) => {
    ...
    // use moves a card
    if (type === "card") {
      let newOrderedDatad = [...orderedData];

      const sourceList = newOrderedDatad.find(
        (list) => list.id === source.droppableId
      );

      const destList = newOrderedDatad.find(
      ...
      // check if cards exists on the sourced list
      if (!sourceList.cards) {
        sourceList.cards = [];
      }
      ...
      if (source.droppableId === destination.droppableId) {
        ...
        setOrderedData(newOrderedDatad);
        ...
        // add a card th the destination list
